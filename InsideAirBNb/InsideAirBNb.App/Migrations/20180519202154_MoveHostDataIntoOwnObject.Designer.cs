...
namespace InsideAirBNB.Data.Migrations
{
    ...
    [Migration("20180519202154_MoveHostDataIntoOwnObject")]
    partial class MoveHostDataIntoOwnObject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsideAirBNB.Models.Host", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InsideAirBNB.Models.NeighbourhoodGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InsideAirBNB.Models.RoomType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InsideAirBNB.Models.Listing", b =>
                {
                    b.HasOne("InsideAirBNB.Models.Host", "Host")
                        .WithMany("Listings")
                        .HasForeignKey("HostId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("InsideAirBNB.Models.RoomType", "RoomType")
                        .WithMany("Listings")
            ...
            modelBuilder.Entity("InsideAirBNB.Models.Neighbourhood", b =>
                {
                    b.HasOne("InsideAirBNB.Models.NeighbourhoodGroup", "NeighbourhoodGroup")
